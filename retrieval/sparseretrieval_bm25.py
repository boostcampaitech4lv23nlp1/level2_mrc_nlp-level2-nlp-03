...
from .get_relevant_doc_bm25 import get_relevant_doc_bm25, get_relevant_doc_faiss
...
class SparseRetrieval_bm25:
    def __init__(self,
        ...
        self.passage_embedding = get_sparse_embedding_bm25(data_path, self.contexts)
        if self.is_faiss:
    ...
    def retrieve(self,
        ...
        # tfidf 대신 bm25를 적용하는 것은 faiss와 별개이므로 faiss에 해당하는 부분은 건들지 않았습니다.
        if isinstance(query_or_dataset, str): # bulk = False
            if self.is_faiss:
                ...
                doc_scores, doc_indices = get_relevant_doc_bm25(query_or_dataset, self.passage_embedding,k=topk,bulk=False)
            ...
            if self.is_faiss:
                ...
                doc_scores, doc_indices = get_relevant_doc_bm25(query_or_dataset['question'], self.passage_embedding, k=topk, bulk=True)
